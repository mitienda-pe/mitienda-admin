...
const DEFAULT_CONFIG: StoreConfig = {
  ...
  tiendageneral_sw_validar_documento: 0,
  tiendageneral_texto_validacion_documento: null,
  tiendageneral_mapa_checkout: 'opcional',
  ...
  async function saveConfig(): Promise<boolean> {
    ...
    try {
      const update: StoreConfigUpdate = {
        ...
        tiendageneral_sw_validar_documento: draftConfig.value.tiendageneral_sw_validar_documento,
        tiendageneral_texto_validacion_documento: draftConfig.value.tiendageneral_texto_validacion_documento,
        tiendageneral_mapa_checkout: draftConfig.value.tiendageneral_mapa_checkout,
        ...
        sw_limitarproducto: draftConfig.value.sw_limitarproducto
      }
